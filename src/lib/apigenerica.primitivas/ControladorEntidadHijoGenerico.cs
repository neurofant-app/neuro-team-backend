...
#pragma warning restore CS8600 // Se va a convertir un literal nulo o un posible valor nulo en un tipo que no acepta valores NULL
    ...
    /// <returns></returns>
    [HttpGet("/api/{entidad}/hijos/{entidadPadre}/{padreId}/metadatos", Name= "DefinicionEntidadHijo")]
    ...
    /// <param name="uOrgID">Id de la unidad organizacional del usuario en sesión</param>
    /// <returns></returns>
    [HttpPut("/api/{entidad}/hijos/{entidadPadre}/{padreId}/entidad/{id}", Name = "PUTGenericoHijo")]
    ...
    /// <param name="uOrgID">Id de la unidad organizacional del usuario en sesión</param>
    /// <returns></returns>
    [HttpGet("/api/{entidad}/hijos/{entidadPadre}/{padreId}/entidad/{id}", Name = "UnicoPorIdHijo")]
    ...
    /// <param name="uOrgID">Id de la unidad organizacional del usuario en sesión</param>
    /// <returns></returns>
    [HttpGet("/api/{entidad}/hijos/{entidadPadre}/{padreId}/entidad/despliegue/{id}", Name = "UnicoPorIdDespliegueHijo")]
    ...
    /// <param name="uOrgID">Id de la unidad organizacional del usuario en sesión</param>
    /// <returns></returns>
    [HttpPost("/api/{entidad}/hijos/{entidadPadre}/{padreId}/entidad/pagina", Name = "PaginaHijo")]
    ...
    /// <param name="uOrgID">Id de la unidad organizacional del usuario en sesión</param>
    /// <returns></returns>
    [HttpPost("/api/{entidad}/hijos/{entidadPadre}/{padreId}/entidad/pagina/despliegue", Name = "PaginaDespliegueHijo")]
    ...
    /// <param name="uOrgID">Id de la unidad organizacional del usuario en sesión</param>
    /// <returns></returns>
    [HttpDelete("/api/{entidad}/hijos/{entidadPadre}/{padreId}/entidad/{id}", Name = "EliminarUnicoHijo")]
