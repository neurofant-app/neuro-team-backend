...
#pragma warning restore CS8600 // Se va a convertir un literal nulo o un posible valor nulo en un tipo que no acepta valores NULL
    ...
    /// <returns></returns>
    [HttpGet("/api/{entidad}/metadatos",Name= "DefinicionEntidad")]
    ...
    /// <returns></returns>
    [HttpPost("/api/{entidad}/entidad",Name = "POSTGenerico")]
    ...
    /// <param name="uOrgID">Id de la unidad organizacional del usuario en sesión</param>
    /// <returns></returns>
    [HttpPut("/api/{entidad}/entidad/{id}",Name = "PUTGenerico")]
    ...
    /// <param name="uOrgID">Id de la unidad organizacional del usuario en sesión</param>
    /// <returns></returns>
    [HttpGet("/api/{entidad}/entidad/{id}",Name = "UnicoPorId")]
    ...
    /// <param name="uOrgID">Id de la unidad organizacional del usuario en sesión</param>
    /// <returns></returns>
    [HttpGet("/api/{entidad}/entidad/despliegue/{id}", Name = "UnicoPorIdDespliegue")]
    ...
    /// <param name="uOrgID">Id de la unidad organizacional del usuario en sesión</param>
    /// <returns></returns>
    [HttpPost("/api/{entidad}/entidad/pagina", Name = "Pagina")]
    ...
    /// <param name="uOrgID">Id de la unidad organizacional del usuario en sesión</param>
    /// <returns></returns>
    [HttpPost("/api/{entidad}/entidad/pagina/despliegue", Name = "PaginaDespliegue")]
    ...
    /// <param name="uOrgID">Id de la unidad organizacional del usuario en sesión</param>
    /// <returns></returns>
    [HttpPost("/api/{entidad}/hijos/{entidadPadre}/{padreId}/pagina", Name = "PaginaHijos")]
    [SwaggerOperation("Obtiene una página de entidades tal como se almacena en el repositorio en base a la consulta", OperationId = "PaginaHijos")]
    [SwaggerResponse(statusCode: 200, type: typeof(PaginaGenerica<object>), description: "Página de datos de entidad")]
    [SwaggerResponse(statusCode: 400, description: "Datos de consulta incorrectos")]
    [SwaggerResponse(statusCode: 403, description: "El usuario en sesión no tiene acceso a la operación")]
    [SwaggerResponse(statusCode: 401, description: "Usuario no autenticado")]
    ...
    /// <param name="uOrgID">Id de la unidad organizacional del usuario en sesión</param>
    /// <returns></returns>
    [HttpGet("/api/{entidad}/hijos/{entidadPadre}/{padreId}/pagina/despliegue", Name = "PaginaDespliegueHijos")]
    [SwaggerOperation("Obtiene una página de entidades para despliegue en base a la consulta",OperationId = "PaginaDespliegueHijos")]
    [SwaggerResponse(statusCode: 200, type: typeof(PaginaGenerica<object>), description: "Página de datos de entidad")]
    [SwaggerResponse(statusCode: 400, description: "Datos de consulta incorrectos")]
    [SwaggerResponse(statusCode: 403, description: "El usuario en sesión no tiene acceso a la operación")]
    [SwaggerResponse(statusCode: 401, description: "Usuario no autenticado")]
    ...
    /// <param name="uOrgID">Id de la unidad organizacional del usuario en sesión</param>
    /// <returns></returns>
    [HttpDelete("/api/{entidad}/entidad/{id}", Name = "EliminarUnico")]
