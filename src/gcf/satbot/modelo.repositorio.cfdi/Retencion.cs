...
namespace modelo.repositorio.cfdi
{
    public class Retencion
    {
        ...
        /// <summary>
        /// Atributo de clave unica, viene de RowId de Sqlite
        /// </summary>
        ...
        /// </summary>
        public decimal Base { get; set; }  //UsoRequerido
        /// <summary>
        ...
        /// </summary>
        public decimal TasaOCuota { get; set; }  //UsoRequerido
        /// <summary>
        ...
        /// </summary>
        public decimal Importe { get; set; }   //UsoRequerido
        ...
        /*
         ...
         Almacena la información de los impuestos retenidos para cada CFDI, debe utilizarse 
         como clave foránea el campo ROWID de la tabla cfdi con la finalidad de economizar 
         espacio. El valor de ROWID es de tipo numerico y el de UUID es texto de longitud 48 
         que es muy grande para repetirse,
         */
    }
}
