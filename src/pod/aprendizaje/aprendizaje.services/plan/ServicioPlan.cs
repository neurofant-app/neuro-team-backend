    ...
    public virtual async Task<Respuesta> Actualizar(string id, Plan data)
    {
        ...
        try
        {
            if (string.IsNullOrEmpty(id) || data == null)
            {
                ...
                {
                    Codigo = CodigosError.APRENDIZAJE_PLAN_ID_PAYLOAD_NO_INGRESADO,
            ...
            if (actual == null)
            {
                respuesta.Error = new ErrorProceso()
                {
                    Codigo = CodigosError.APRENDIZAJE_PLAN_NO_ENCONTRADA,
    ...
    public virtual async Task<Respuesta> Eliminar(string id)
    {
        ...
        try
        {
            ...
            if (string.IsNullOrEmpty(id))
            {
                respuesta.Error = new ErrorProceso()
                {
                    Codigo = CodigosError.APRENDIZAJE_PLAN_ID_NO_INGRESADO,
