    ...
    IServicioEntidadAPI, IServicioEntidadInstructor
{
    ...
    public override async Task<Respuesta> Actualizar(string id, ActualizaInstructor data, StringDictionary? parametros = null)
    {
    ...
    public override async Task<RespuestaPayload<EntidadInstructor>> UnicaPorId(string id, StringDictionary? parametros = null)
    {
