    ...
    IServicioEntidadAPI, IServicioEspacioTrabajo
{
    ...
    public override async Task<ResultadoValidacion> ValidarEliminacion(string id, EspacioTrabajo original, bool forzarEliminacion = false)
    {
        return new ResultadoValidacion() { Valido = true };
    }
    ...
    public override async Task<Respuesta> Actualizar(string id, EspacioTrabajo data, StringDictionary? parametros = null)
    {
